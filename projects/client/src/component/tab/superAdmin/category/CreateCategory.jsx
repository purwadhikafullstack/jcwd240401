...
export default function CreateCategory() {
    ...
    return (
        <div className='w-8/12 mx-auto flex flex-col justify-center font-inter'>
            ...
            <Formik initialValues={{ name: "", file: null, }} validationSchema={createCategorySchema} onSubmit={handleSubmit}>
                {(props) => (
                    <Form>
                        <div className="flex flex-col gap-2 py-4 font-inter mb-4">
                            <label htmlFor="name" className="">Category Name <span className="text-xs text-reddanger">* required</span></label>
                        ...
                        <div className="flex flex-col gap-2 py-4 mb-4">
                            <label htmlFor="file" className="">Category Image <span className="text-xs text-reddanger">* required</span></label>
                            <div className='relative'>
