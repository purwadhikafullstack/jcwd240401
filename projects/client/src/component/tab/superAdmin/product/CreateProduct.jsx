                ...
                {(props) => (
                    <Form>
                        ...
                        <div className="flex flex-col gap-2 py-4 mb-24">
                            ...
                            <div className='relative'>
                                <input className='border border-gray-300 text-sm w-full focus:border-darkgreen focus:ring-0' type="file" id="file" name="file" onChange={(e) => { props.setFieldValue("file", e.currentTarget.files[0]); preview(e) }} required />
